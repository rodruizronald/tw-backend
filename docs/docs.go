...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/httpservice.ErrorResponse"
                        }
                    }
                }
            },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/httpservice.HealthResponse"
                        }
                    },
                    "503": {
    ...
    "definitions": {
        ...
        "httpservice.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "$ref": "#/definitions/httpservice.ErrorDetails"
                }
            }
        },
        "httpservice.HealthResponse": {
            "type": "object",
            "properties": {
                "checks": {
                    "type": "object",
